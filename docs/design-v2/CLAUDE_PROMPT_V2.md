...
1. `handoff/V2_BRIEF.md` — what to build (Settings S1, Coverage Passport W2, Lifetime Certificate paywall P1, gold member card P3, notification soft-ask N1, App Store assets).
